...
__attribute__((section("__versions"))) = {
	...
	{ 0x762e3553, __VMLINUX_SYMBOL_STR(tty_port_register_device) },
	...
	{ 0xe5405eea, __VMLINUX_SYMBOL_STR(tty_standard_install) },
